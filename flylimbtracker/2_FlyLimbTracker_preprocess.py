...
data_dir = "/data/LiftFly3D/flylimbtracker/network"
...
def main():
    ...
    test_set, data_mean, data_std, targets_1d, targets_2d = create_xy_data(
        actions, data_dir, target_sets, ref_points
    )
    ...
    for fly in flies:
        for action in actions:
            ...
            for fname_ in fname:
                ...
                ] = poses2d  # [:-4] is to get rid of .pkl extension
